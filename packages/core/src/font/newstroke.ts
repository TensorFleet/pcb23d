/**
 * Newstroke stroke font by Vladimir Uryvaev (http://vovanium.ru/sledy/newstroke), the default
 * font of KiCad, released to the public domain (CC0 1.0). Glyphs U+0020..U+00FF in KiCad's
 * compiled encoding: the first two characters are the left/right advance, each further pair is
 * an (x, y) point encoded as char - 'R', and " R" lifts the pen. Regenerated from KiCad's
 * common/newstroke_font.cpp by scripts/extract-newstroke.py.
 */
export const NEWSTROKE_FIRST_CODEPOINT = 0x20;
...
"H]LLOO RLYOV RVOYL RVVYY RVVTWQWOVNTNQOOQNTNVOWQWTVV", 
"F^JTZT RJMZM RRQR[ RKFRQYF", 
"MWRFRQ RRbRW", 
"I[N]P^S^U]V[UYOSNQNPONQM RVGTFQFOGNIOKUQVSVTUVSW", 
"LXNFOGNHMGNFNH RVFWGVHUGVFVH", 
"@dRCMDHGELDQEVH[M^R_W^\\[_V`Q_L\\GWDRC RVKTJPJNKLMKOKSLUNWPXTXVW", 
"KZOEQDSDUEVGVN RVMTNQNOMNKOIQHVH", 
"H\\RMLSRY RXWTSXO", 
"E_JQZQZV", 
"RR", 
"@dNXNJTJVKWMWOVQTRNR RRCMDHGELDQEVH[M^R_W^\\[_V`Q_L\\GWDRC RWXRR", 
"LXMGWG", 
...
"E_RLSMRNQMRLRN RRXSYRZQYRXRZ RZSJS", 
